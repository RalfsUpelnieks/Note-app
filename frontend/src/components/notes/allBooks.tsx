                ...
                <tbody>
                    {books.length !== 0 ?
                        ...
                        <tr className="border-0 border-solid border-t text-center border-gray-300">
                            <td colSpan={6} className="text-neutral-400 font-semibold">No books found</td>
                        </tr>
                    }
                    <tr onClick={AddBook} className="border-0 border-solid border-t text-center border-gray-300 hover:bg-zinc-100 hover:cursor-pointer">
                        <td colSpan={6} className="py-1 text-neutral-400 hover:text-neutral-600">Add a Book</td>
                    </tr>
                </tbody>
            </table>
        </div>
