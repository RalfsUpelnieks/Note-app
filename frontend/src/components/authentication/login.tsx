...
function Login() {
    ...
    return(
        <PopUp title='NoteBooks' navChildren={<LinkButton Text='Register' Link={ROUTES.Register}></LinkButton>}>
            <form className='px-10 pb-8 pt-7 flex flex-col' onSubmit={handleSubmit}>
                ...
                <a href={ROUTES.ForgotPassword} className='no-underline hover:underline text-blue-700 opacity-80 text-sm'>Forgot password?</a>
